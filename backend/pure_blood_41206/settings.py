"""
Django settings for pure_blood_41206 project.
...
ROOT_URLCONF = 'pure_blood_41206.urls'
...
WSGI_APPLICATION = 'pure_blood_41206.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pure_blood_41206 API",
    "DESCRIPTION": "API documentation for pure_blood_41206 App",
    "VERSION": "v1",
}
